...
public class CameraControl : MonoBehaviour
{
    ...
    private void CameraRotation()
    {
        ...
        if (player.transform.position.x > 5 && cameraPositions != Positions.onRight)
        {
        ...
        else if (player.transform.position.x < -5 && cameraPositions != Positions.onLeft)
        {
        ...
        else if (player.transform.position.x > -5 && player.transform.position.x < 5 && cameraPositions != Positions.onMiddle)
        {
            cameraPositions = Positions.onMiddle;
